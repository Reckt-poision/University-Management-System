...
public class EnterMarks extends JFrame implements ActionListener{
    ...
    EnterMarks(){
        ...
        lblrollnumber.setBounds(70, 70, 150, 20);
        lblrollnumber.setFont(new Font("serif", Font.PLAIN, 15));
        add(lblrollnumber);
        
        crollno = new Choice();
        crollno.setBounds(220, 70, 200, 20);
        add(crollno);
        ...
        lblsemester.setBounds(70, 110, 150, 20);
        lblsemester.setFont(new Font("serif", Font.PLAIN, 15));
        add(lblsemester);
        
        String semester[] = {"1st semester","2nd semester","3rd semester","4th semester","5th semester","6th semester","7th semester","8th semester"};
        cbsemester = new JComboBox(semester);
        cbsemester.setBounds(220, 110, 150, 20);
        add(cbsemester);
        
        JLabel lblentersubject= new JLabel("Enter Subject:");
        lblentersubject.setBounds(100, 150, 200, 40);
        lblentersubject.setFont(new Font("serif", Font.PLAIN, 15));
        add(lblentersubject);
        
        JLabel lblentermarks= new JLabel("Enter Marks:");
        lblentermarks.setBounds(320, 150, 200, 40);
        lblentermarks.setFont(new Font("serif", Font.PLAIN, 15));
        add(lblentermarks);
